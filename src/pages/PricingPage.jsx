...
const PricingPage = () => {
  ...
  const plans = [
    ...
    },
    {
      ...
      otts: ["hotstar", "xstream","prime", "zee5","netflix","appletv"],
    },
    {
      id: 5,
      name: "Wi-Fi + OTT + TV",
      ...
      features: [
        ...
        { text: "Free Router", available: true },
        { text: "Free 4K Android Box", available: true },
        { text: "350+ IPTV Channels", available: true },
        { text: "16+ OTT Apps", available: true },
      ],
      otts: ["hotstar", "prime", "xstream",  "zee5", "netflix","appletv"],
    },
  ];
  ...
  const faqs = [
    {
      ...
      answer:
        "Our technicians will visit your location at the scheduled time. The installation typically takes 1-2 hours, during which they will set up the fiber connection, configure the router, and ensure everything is working properly.",
    },
    {
      id: 2,
      question: "Is there any installation fee?",
      answer:
        "We offer free installation for all our broadband plans. There are no hidden charges or setup fees.",
    },
    {
      id: 3,
      question: "How long does it take to get the connection activated?",
      answer:
        "After you submit your request, we typically schedule the installation within 24-48 hours based on your convenience.",
    },
    {
      id: 4,
      question: "Do you provide a Wi-Fi router?",
      answer:
        "Yes, we provide a high-quality Wi-Fi router free of cost with all our plans. The router supports dual-band Wi-Fi for optimal performance.",
    },
    {
      id: 5,
      question: "What is your billing cycle?",
      answer:
        "We follow a monthly billing cycle. You can choose to pay monthly or opt for quarterly or annual plans for additional discounts.",
    },
    {
      id: 6,
    ...
    <>
        ...
        <div className="container text-center">
          <div className="max-w-3xl mx-auto animate-fadeIn">
            ...
            <p className="text-xl text-white/80">
              Choose the perfect plan for your home or business. All plans
              include free installation and router.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="flex flex-wrap justify-center mb-16">
            <div className="w-full md:w-10/12 lg:w-8/12">
              <p className="text-center text-lg text-gray-600 max-w-3xl mx-auto mb-8">
                Our plans are designed to provide you with the best internet
                experience. Choose the one that suits your needs.
              </p>
            </div>
          </div>
                  ...
                  <ul className="space-y-4 mb-8">
                    {plan.features.map((feature, fIndex) => (
                      <li key={fIndex} className="flex items-center">
                        ...
                        <span
                          className={feature.available ? "" : "text-gray-400"}
                        >
                          {feature.text}
                        </span>
                      </li>
      ...
      <section className="bg-primary/5 py-20">
        <div className="container text-center">
          ...
          <p
            className="text-lg text-gray-600 mb-10 max-w-3xl mx-auto animate-fadeIn"
            style={{ animationDelay: "0.2s" }}
          >
            Contact us today to get started with our fiber broadband services.
